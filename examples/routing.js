  ...
  _fn = function() {
    ...
    if (typeof obj === 'function') {
      try {
        ...
        return console.log("[-] path=" + path + ", err=", e);
      }
    } else {
